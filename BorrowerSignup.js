document.addEventListener('DOMContentLoaded', function() {
    ...
    courseDropdown.addEventListener('click', function() {
      courseOptions.style.display = courseOptions.style.display === 'block' ? 'none' : 'block';
    ...
    const courseOptionElements = courseOptions.querySelectorAll('.dropdown-option');
    ...
    document.addEventListener('click', function(event) {
      if (!courseDropdown.contains(event.target) && !courseOptions.contains(event.target)) {
        courseOptions.style.display = 'none';
      }
